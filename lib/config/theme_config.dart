...
class AppTheme {
  ...
  static final InputDecorationTheme _inputTheme = InputDecorationTheme(
    ...
    focusedBorder: _inputBorder.copyWith(borderSide: BorderSide(color: AppColors.borderPrimary)),
    errorBorder: _inputBorder.copyWith(borderSide: BorderSide(color: AppColors.textDanger))
  );
}
